...
namespace Ray.Infrastructure.Extensions
{
    public static class ObjectExtensions
    {
        ...
        public static string ToJson<T>(this T obj, Action<JsonSerializerSettings> settingAction)
        {
            JsonSerializerSettings jsonSerializerSettings = new JsonSerializerSettings();
            settingAction(jsonSerializerSettings);
            return obj.ToJson(jsonSerializerSettings);
        }
