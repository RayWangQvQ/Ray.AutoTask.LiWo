...
namespace Ray.AutoTask.Infrastructure.Options
{
    /// <summary>
    /// 安全相关配置
    /// </summary>
    public class SecurityOptions
    {
        ...
        /// </summary>
        public bool IsSkipRun { get; set; } = false;

        /// <summary>
        /// 两次调用api之间间隔的秒数[0,+]
        /// 有人担心在几秒内连续调用api会被安全机制发现，所以为不放心的朋友添加了间隔秒数配置，两次调用Api之间会大于该秒数
        /// </summary>
